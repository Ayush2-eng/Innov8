...
class LoginFrame(Frame):
    ...
    def page1(self):
        ...
        #.geometry('1050x650')
        os.system("python ticket_cancel.py")
    ...
    def page2(self):
        ...
        os.system("python ticketsview.py")
    ...
    def page3(self):
        os.system("python ticket_booking.py")

    def page4(self):
        os.system("python 03_face_recognition.py")    

    def page5(self):
        os.system("python 04_exit_level.py")     
    ...
    def _login_btn_clicked(self):
        ...
        if validate==1:
            ...
            r.geometry('600x250') # Makes the window a certain size
            rlbl = Label(r, text='\n Welcome '+station_name+' Station', bg="green", fg= "white") # "logged in" label
            page1btn = Button(r, text="Ticket Cancellation", command=self.page1)
            page2btn = Button(r, text="Ticket View", command=self.page2)
            page4btn = Button(r, text="Ticket Status by face recognition", command=self.page4)
            page3btn = Button(r, text="Ticket Booking", command=self.page3)
            page5btn = Button(r, text="Exit station", command=self.page5)
            
            page1btn.pack(side=BOTTOM)
            page2btn.pack(side=BOTTOM)
            page3btn.pack(side=BOTTOM)
            page4btn.pack(side=BOTTOM)
            page5btn.pack(side=BOTTOM)
            rlbl.config(font=("Courier",24))

            #page3btn.pack(side="left")
            #page4btn.pack(side="left")
            rlbl.pack(side=TOP, fill=X) # Pack is like .grid(), just different
            r.mainloop()
        else:
